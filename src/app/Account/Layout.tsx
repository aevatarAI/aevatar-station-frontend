...
export default function Layout({
  ...
  return (
    <div className="flex flex-col h-screen lg:flex-row lg:gap-20 relative min-h-[600px]">
      ...
      <div className=" flex flex-col gap-[30px] basis-1/2 items-start lg:justify-center lg:items-center py-9 px-[47px]">
        <DescHome />

        <div className="h-[1px] w-full bg-black-light lg:hidden" />
