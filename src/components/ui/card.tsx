...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "border bg-[#141415] text-card-foreground shadow-2xs cutCorner",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "text-[15px] font-semibold leading-none tracking-tight font-outfit mb-[7px]",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("font-outfit text-[12px] text-[#B9B9B9]", className)}
    {...props}
  />
));
