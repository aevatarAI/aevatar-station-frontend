        ...
        <DialogHeader>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}>
              <div className="flex flex-col gap-y-[22px] pt-[22px] items-start content-start self-stretch">
                <FormField
                  key={"name"}
                  ...
                  render={({ field }) => (
                    <FormItem aria-labelledby="project" className="w-full">
                      ...
                      <Select
                        ...
                        <SelectContent className="w-[259px] p-[8px_8px_20px_10px] cutCorner cutCorner__white">
