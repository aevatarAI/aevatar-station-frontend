...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        months: "flex flex-col sm:flex-row gap-4 font-syne font-bold justify-center",
      ...
      components={{
        IconLeft: ({ className, ...props }) => (
          <ChevronLeft className={cn("size-4 text-[#B9B9B9]", className)} {...props} />
        ),
        IconRight: ({ className, ...props }) => (
          <ChevronRight className={cn("size-4 text-[#B9B9B9]", className)} {...props} />
        ),
      }}
      {...props}
    />
