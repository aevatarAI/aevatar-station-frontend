...
export default function ProfileAvatar() {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger className="h-[34px]">
      ...
      >
        ...
        {/* Account Section */}
        <div
          className={"flex flex-col items-start justify-start p-1 w-full pb-0"}
        >
          <div
        ...
        <div
          className={"flex flex-col items-start justify-start p-1 w-full pt-0"}
        >
          <div
            className={`flex gap-2 items-center justify-start min-w-32 pl-8 pr-2 py-1.5 rounded w-full relative cursor-pointer transition-colors ${
              theme === "dark"
